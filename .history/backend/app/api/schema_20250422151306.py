...
class DesignParameters(BaseModel):
    ...
    __root__: Dict[str, Any] = Field(..., description="Parameter values for this design")
...
class Predictions(BaseModel):
    ...
    __root__: Dict[str, Prediction] = Field(..., description="Predictions for each objective")
...
class ObjectiveResults(BaseModel):
    """Model for objective function results."""
    __root__: Dict[str, float] = Field(..., description="Values for each objective")
