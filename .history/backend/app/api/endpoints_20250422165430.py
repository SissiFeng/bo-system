...
async def get_parameter_space(task_id: str = Path(None, description="Task ID")):
    """
...
async def update_parameter_space(
    ...
    task_id: str = Path(None, description="Task ID"),
):
    """
...
async def get_strategy(task_id: str = Path(None, description="Task ID")):
    """
...
async def get_model_performance(task_id: str = Path(None, description="Task ID")):
    """
...
async def get_pareto_front(task_id: str = Path(None, description="Task ID")):
    """
