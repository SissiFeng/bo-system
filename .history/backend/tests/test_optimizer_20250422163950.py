...
class TestBayesianOptimizer(unittest.TestCase):
    ...
    def test_suggest_model_trained(self):
        ...
        self.assertEqual(len(suggestions), 1)
        self.assertIsInstance(suggestions[0], dict)
        # Check if the suggestion matches the mock acquisition's output (after conversion)
        self.assertDictEqual(suggestions[0], self.suggest_point_external)
        # Check if acquisition optimize was called
